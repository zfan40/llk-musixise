...
<div class="main">
  <header style="height:80px;">
    ...
    <div style="background-color:#00bdd4;height: 40px;line-height:40px;padding-left:20px;">
      ...
      <i id="export-midi" class="iconfont icon-geshi_yinpinmidi" style="font-size:26px;cursor: pointer;padding-left:10px;" @click="handleExportMidi"></i>
