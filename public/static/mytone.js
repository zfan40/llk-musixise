(function(root, factory) {
          ...
          method: function(capture) {
            if (Tone.Transport) {
              ...
              return this._secondsToUnits(
                Tone.Transport.nextSubdivision(quantTo)
              );
            } else {
              return 0;
            }
  ...
  Module(function(Tone) {
    ...
    Tone.FeedbackCombFilter = function() {
       ...
       *  @private
       */
      this._delay = this.input = this.output = new Tone.Delay(
        options.delayTime
      );
      /**
  ...
  Module(function(Tone) {
    ...
    Tone.BufferSource.prototype._onended = function() {
      if (!this._sourceStopped) {
        ...
        var additionalTail =
          this.curve === "exponential" ? this.fadeOut * 2 : 0;
  ...
  Module(function(Tone) {
    ...
    Tone.TransportTimelineSignal.prototype.exponentialRampToValueAtTime = function(
      ...
      time = Tone.TransportTime(time);
      Tone.Signal.prototype.exponentialRampToValueAtTime.call(
        this,
        value,
        time
      );
    ...
    Tone.Player.prototype._stopAtNextIteration = function(now) {
      if (this._state.getValueAtTime(now) === Tone.State.Started) {
        ...
        var iterations = Math.max(
          Math.ceil(position / this.buffer.duration),
          1
        );
